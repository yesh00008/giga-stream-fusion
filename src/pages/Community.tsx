...
export default function Community() {
  ...
  return (
    <div className="flex-1 overflow-y-auto pb-20 lg:pb-0 bg-background">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 max-w-7xl mx-auto p-4 sm:p-6">
        {/* Main Feed */}
